...
export class InvitationAnimationService {
  private readonly profiles: Record<string, InvitationAnimationProfile> = {
    'soft-ivory': {
      ...
      staggerSelector: 'h1, h2, h3, p, blockquote, button, a, strong, small, iframe, .ruby-caption, .ruby-caption__eyebrow, .ruby-caption__title, .ruby-quote-line, .ruby-couple-line, .ruby-gallery-line, .ruby-wish-line, .ruby-gift-line, .ruby-cover__names, .ruby-cover__date, .ruby-cover__guest, .ruby-couple-card, .ruby-couple-photo, .ruby-event-card, .ruby-map-card, .ruby-map-preview, .ruby-countdown, .ruby-countdown-box, .gallery-card, .ruby-gallery-carousel, .ruby-gallery-slide, .ruby-gallery-feature, .ruby-gallery-thumb, .ruby-wish-form, .ruby-wish-card, .ruby-bank-card, .ruby-footer-content, .ruby-cover-frame, .ruby-quote-frame, .ruby-location-frame, .ruby-wish-frame, .ruby-gift-frame, .ruby-footer-frame, .ruby-floral',
